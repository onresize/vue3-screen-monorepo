...
let websocket = {
  onConnectWebSocket: function (guidHexString) {},
  onConnectWebSocketError: function (error) {},
  ...
  onDefaultMessage: function (cmdName, argString, jsonObj) {},
  ...
  ProcessReceiveWSMessage: function (message) {
    ...
    if (message.match(websocket.MESSAGEEND)) {
      ...
      console.log(usefulValue.cmdName)
      ...
      switch (usefulValue.cmdName) {
        ...
        case 'WebRTCMessageToWebBrowser':
          //console.log("WebRTCMessageToWebBrowser++++++++++++++++++++++++++:");
          //console.log(messagePayloadJsonData);
...
let webrtc = {
  ...
  onWebRtcAnswer(webRTCData) {
    ...
    webrtc.webRtcPlayerObj.aggregateStats(1 * 1000 /*Check every 1 second*/)
