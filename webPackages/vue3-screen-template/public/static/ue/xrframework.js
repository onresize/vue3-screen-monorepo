var XR = (function (t) {
  ...
  function (t, e, i) {
    ...
    function E(t = !1, e, i = !1, r = !1, m = 1920, M = 1080) {
      ;(T = i),
        ...
        (document.onkeydown = function (t) {
          'Escape' == t.key && D('Quit'),
            'F11' == t.key && D('FullScreen'),
            'F12' == t.key && D('ShowDevTools'),
            t.repeat || D('OnKeyEvent ' + t.key + ' 1')
        }),
        (document.onkeyup = function (t) {
          t.repeat || D('OnKeyEvent ' + t.key + ' 0')
        }),
        (window.onblur = function (t) {
          H('Web Window Lost Focus'),
            console.log('Web Window Lost Focus'),
            D('KeyboardMovePos 0 0')
        })
    }
    function R(t) {
    ...
    function U(t) {
      C('ExecuteUEConsoleCommand', t.replace(' ', '$'), '{}')
    }
    function H(t, e = !0) {
    ...
    class F {
      ...
      OnMouseDown(t, e) {
        if (
          ...
          this.sendMessage && 0 == t.button)
        ) {
          D(
            'OnPressedScreenPercent ' +
              e +
              ' ' +
              t.clientX / L +
              ' ' +
            ...
            D('OnOnePointDown ' + e + ' ' + t.clientX + ' ' + t.clientY)
        }
        t.button == p
          ? (T ||
              ((this.touchList[0] = {
      ...
      OnMouseMove(t, e) {
        if (this.touchList[0]) {
          ...
          g > 1 &&
            ...
            this.OnUIMove(i, n),
            this.sendMessage && D('OnUIMove ' + e + ' ' + i + ' ' + n),
          ...
          g > 1 &&
            ...
            this.sendMessage && D('OnUIRot ' + e + ' ' + i + ' ' + n),
      ...
      OnMouseUp(t, e) {
        D(
          ...
          this.sendMessage &&
            0 == t.button &&
            (D('OnPressedScreenPercent ' + e + ' ' + -1 + ' ' + -1),
            D('OnOnePointUp ' + e + ' ' + t.clientX + ' ' + t.clientY)),
      ...
      OnWheel(t, e) {
        ...
        t.deltaY > 0 ? (o *= 1) : (o *= -1),
          this.sendMessage && D('OnUIZoom ' + e + ' ' + o),
          D('OnWheel ' + e + ' ' + o),
          (O = i)
      }
      OnTouchStart(t, e) {
      ...
      OnTouchMove(t, e) {
        ...
        if (1 == this.idList.length) {
          ...
          g > 1 &&
            ...
            this.OnUIMove(t, i),
            this.sendMessage && D('OnUIMove ' + e + ' ' + t + ' ' + i),
            (this.touchList[this.idList[0]].lX =
              this.touchList[this.idList[0]].cX),
            (this.touchList[this.idList[0]].lY =
              this.touchList[this.idList[0]].cY))
          ...
          g > 1 &&
            ...
            this.OnUIZoom(t),
            this.sendMessage && D('OnUIZoom ' + e + ' ' + t),
            (this.touchList[this.idList[0]].lX =
              this.touchList[this.idList[0]].cX),
            (this.touchList[this.idList[0]].lY =
              this.touchList[this.idList[0]].cY),
          ...
          g > 1 &&
            ...
            this.sendMessage && D('OnUIPan ' + e + ' ' + t + ' ' + i),
            (this.touchList[this.idList[0]].lX =
              this.touchList[this.idList[0]].cX),
            (this.touchList[this.idList[0]].lY =
              this.touchList[this.idList[0]].cY))
      ...
      OnTouchEnd(t, e) {
        for (let e = 0; e < t.changedTouches.length; e++)
          t.currentTarget.id === this.name &&
            ...
            W(this.idList, t.changedTouches[e].identifier))
        H(
          ...
          1 == t.touches.length
            ...
            : this.sendMessage && D('OnOnePointUp ' + e)
      }
      OnTouchCancel(t, e) {
